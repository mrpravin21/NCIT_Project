        ...
        <body>
            ...
            <div class="container-fluid">
                ...
                <ul class="navbar-nav col-lg-6 justify-content-lg-center">
                    ...
                    <li class="nav-item">
                    <a class="nav-link" href="home.php#poll-sec" id="admin-poll">Polls</a>
                    </li>
                    <li class="nav-item">
                    <a class="nav-link" href="home.php#event-resource-sec" id="admin-event">Events</a>
                    </li>
                    <li class="nav-item">
                    <a class="nav-link" href="home.php#event-resource-sec" id="admin-resource">Resources</a>
                    </li>
                </ul>
            ...
            <div class="poll-results">
                <div><h1 class="display-5 text-body-emphasis lh-1 mb-3"><span class="main-text">Poll Results of </span><span class="fw-bold main-text">'<?php echo $poll['poll_title']; ?>'</span></h1><div>
                <div><p style="margin-top: 3rem; color: green;" class="lead fw-bold">Yes Votes: <span class="main-text fw-bold"><?php echo $poll['poll_yes_votes']; ?></span></p><div>
                <div><p style="margin-top: 3rem; color:red;" class="fw-bold">No Votes: <span class="main-text fw-bold"><?php echo $poll['poll_no_votes']; ?></span></p><div>
            </div>
